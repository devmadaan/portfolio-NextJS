  ...
  return (
    <nav
      ...
      <div className="w-full flex justify-between items-center max-w-7x1 mx-auto">
        ...
        >
          <img src={logo2} alt="logo" className="w-9 h-9 object-contain rounded-full" />
          <p className="text-white text-[18px] font-bold cursor-pointer flex">Dev Madaan &nbsp; <span className="sm:block hidden">| Creative Frontend Developer</span> </p>
        </Link>
        ...
        <div className='sm:hidden flex  flex-1 justify-end items-center'>
          ...
          <div className={`${!toggle ? 'hidden' : 'flex'} p-6 black-gradient absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}>
            <ul className="ist-none flex justify-end items-start flex-1 flex-col gap-4">
              {navLinks.map((Link) => (
